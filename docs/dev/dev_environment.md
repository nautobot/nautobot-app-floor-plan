...
- `project_name`: the default docker compose project name (default: `nautobot_floor_plan`)
...
#14 naming to docker.io/nautobot-floor-plan/nautobot:latest-py3.7 done
```
...
ee90fbfabd77   nautobot-floor-plan/nautobot:latest-py3.7   "nautobot-server rqw…"   16 seconds ago   Up 13 seconds                                               nautobot_floor_plan_worker_1
b8adb781d013   nautobot-floor-plan/nautobot:latest-py3.7   "/docker-entrypoint.…"   20 seconds ago   Up 15 seconds   0.0.0.0:8080->8080/tcp, :::8080->8080/tcp   nautobot_floor_plan_nautobot_1
d64ebd60675d   nautobot-floor-plan/nautobot:latest-py3.7   "mkdocs serve -v -a …"   25 seconds ago   Up 18 seconds   0.0.0.0:8001->8080/tcp, :::8001->8080/tcp   nautobot_floor_plan_docs_1
...
So for example, our plugin is named `nautobot-floor-plan`, the command would most likely be `docker logs nautobot_floor_plan_nautobot_1 -f`. You can find the name of all running containers via `docker ps`.

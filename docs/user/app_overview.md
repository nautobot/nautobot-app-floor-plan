...
- Provides easy navigation from Object to Floor Plan. Object will be centered and zoomed in for 5 seconds and highlighted on Floor Plan for 20 seconds.
...
- Extends the detail view of Nautobot Devices, Power Feeds, Power Panels, and Racks.
    - Includes an "View on Floor Plan" button if the Object is on a "Floor Plan Tile".
